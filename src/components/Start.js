...
export default function Start() {
  ...
  function TextSection() {
    //Här bakas paragrafer från inspo-texten ut i components.
    return startParagraphs.map((text, index) => {
      ...
      return (
        <div
          className="textBlockHolder"
          key={index}
          style={{ display: "flex", justifyContent: position }}
        >
          {" "}
          {/* Dynamisk positionering, därför lämnad utanför css.*/}
